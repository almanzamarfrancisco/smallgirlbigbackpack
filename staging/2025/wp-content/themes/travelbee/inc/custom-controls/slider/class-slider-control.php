<?php
/**
 * Travelbee Customizer Slider Control.
 * 
 * @package Travelbee
*/
...
if ( ! class_exists( 'Travelbee_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Travelbee_Slider_Control extends WP_Customize_Control {

		public $type = 'travelbee-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'travelbee-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'travelbee-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
