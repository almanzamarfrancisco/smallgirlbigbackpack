...
if( ! function_exists( 'travelbee_getting_started_menu' ) ) :
/**
 * Adding Getting Started Page in admin menu
 */
function travelbee_getting_started_menu(){	
	add_theme_page(
		__( 'Getting Started', 'travelbee' ),
		__( 'Getting Started', 'travelbee' ),
		'manage_options',
		'travelbee-getting-started',
		'travelbee_getting_started_page'
	);
}
endif;
add_action( 'admin_menu', 'travelbee_getting_started_menu' );

if( ! function_exists( 'travelbee_getting_started_admin_scripts' ) ) :
/**
 * Load Getting Started styles in the admin
 */
function travelbee_getting_started_admin_scripts( $hook ){
	// Load styles only on our page
	if( 'appearance_page_travelbee-getting-started' != $hook ) return;

    wp_enqueue_style( 'travelbee-getting-started', get_template_directory_uri() . '/inc/getting-started/css/getting-started.css', false, TRAVELBEE_THEME_NAME );
    
    wp_enqueue_script( 'plugin-install' );
    wp_enqueue_script( 'updates' );
    wp_enqueue_script( 'travelbee-getting-started', get_template_directory_uri() . '/inc/getting-started/js/getting-started.js', array( 'jquery' ), TRAVELBEE_THEME_NAME, true );
    wp_enqueue_script( 'travelbee-recommended-plugin-install', get_template_directory_uri() . '/inc/getting-started/js/recommended-plugin-install.js', array( 'jquery' ), TRAVELBEE_THEME_NAME, true );    
    wp_localize_script( 'travelbee-recommended-plugin-install', 'travelbee_start_page', array( 'activating' => __( 'Activating ', 'travelbee' ) ) );
}
endif;
add_action( 'admin_enqueue_scripts', 'travelbee_getting_started_admin_scripts' );

if( ! function_exists( 'travelbee_call_plugin_api' ) ) :
/**
 * Plugin API
**/
function travelbee_call_plugin_api( $plugin ) {
...
if( ! function_exists( 'travelbee_check_for_icon' ) ) :
/**
 * Check For Icon 
**/
function travelbee_check_for_icon( $arr ) {
	if( ! empty( $arr['svg'] ) ){
...
if( ! function_exists( 'travelbee_getting_started_page' ) ) :
/**
 * Callback function for admin page.
*/
function travelbee_getting_started_page(){ ?>
	<div class="wrap getting-started">
		<h2 class="notices"></h2>
		<div class="intro-wrap">
			<div class="intro">
				<h3><?php printf( esc_html__( 'Getting started with %1$s v%2$s', 'travelbee' ), TRAVELBEE_THEME_NAME, TRAVELBEE_THEME_VERSION ); ?></h3>
				<h4><?php printf( esc_html__( 'You will find everything you need to get started with %1$s below.', 'travelbee' ), TRAVELBEE_THEME_NAME ); ?></h4>
			</div>
		</div>
			...
			<ul class="inline-list">
				<li class="current">
                    <a id="plugins" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Recommended Plugins', 'travelbee' ); ?>
                    </a>
                </li>
				<li>
                    <a id="help" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Getting Started', 'travelbee' ); ?>
                    </a>
                </li>
				<li>
                    <a id="support" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'FAQ\'s &amp; Support', 'travelbee' ); ?>
                    </a>
                </li>
				<li>
                    <a id="free-pro-panel" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Free Vs Pro', 'travelbee' ); ?>
                    </a>
                </li>
			</ul>
